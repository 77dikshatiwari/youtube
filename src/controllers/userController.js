...
const getUserChannelProfile = asyncHandler (async(req, res)=> {
  ...
  if(!username?.trim()){
    throw new ApiError(400, "Please provide username or Username is missing")
  }
  ...
  if(!channel?.length){
    throw new ApiError(404, "Channel not found or does not exists")
  }
  return res
  .status(200)
      ...
      $lookup: {
        ...
        pipeline: [
          ...
          },
          {
            ...
            // arrayElemetAt: ["$uploader", 0] can be used
            }
          }
        ]
      }
